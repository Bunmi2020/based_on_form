...
function SerieAPredictionsN() {

    ReactGA.send({
        hitType:"pageview",
        page:"/serie_a_predictions_week_25",
        title:"Week 26 Serie A Predictions",
    });
    ...
    const urls = ['https://bunmi2020.github.io/bnf_data/week_nineteen/serie_a.json'];
    useEffect(() => {
    ...
    return (
        <div>
        <Helmet>
            <title>Week 26 Serie A Predictions</title>
            <meta name="description" content="Explore all Serie A Predictions predictions!! This week's Serie A Predictions predictions, with accurate football betting tips, corner statistics, and match data and analysis, across the top five leagues and the Eredivisie, to elevate your football betting strategy." />
            <meta name="keywords" content="Week 26 Serie A Predictions, this week's Serie A Predictions predictions, football predictions, free betting prediction and insights, free football predictions, free football betting tips, free football betting predictions, football match analysis, sports betting insights, best football prediction site, accurate football betting tips, free football predictions, football betting form, football betting predictions today, basedonform.com" />
...
export default SerieAPredictionsN;
