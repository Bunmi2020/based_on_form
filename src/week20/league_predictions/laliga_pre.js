...
function LaLigaPredictionsN() {

    ReactGA.send({
        hitType:"pageview",
        page:"/laliga_predictions_week_26",
        title:"Week 26 La Liga Predictions",
    });
    ...
    const urls = ['https://bunmi2020.github.io/bnf_data/week_twenty/la_liga.json'];
    useEffect(() => {
    ...
    return (
        <div>
        <Helmet>
            <title>Week 26 La Liga Predictions</title>
            ...
            <meta name="keywords" content="Week 26 La Liga Predictions, this week's La Liga Predictions predictions, football predictions, free betting prediction and insights, free football predictions, free football betting tips, free football betting predictions, football match analysis, sports betting insights, best football prediction site, accurate football betting tips, free football predictions, football betting form, football betting predictions today, basedonform.com" />
...
export default LaLigaPredictionsN;
