...
function BundesligaPredictionsN() {
    ...
    ReactGA.send({
        hitType:"pageview",
        page:"/bundesliga_predictions_week_24",
        title:"Week 24 Bundesliga Predictions",
    });
    ...
    const urls = ['https://bunmi2020.github.io/bnf_data/week_twenty/bundesliga.json'];
    useEffect(() => {
    ...
    return (
        <div>
        <Helmet>
            <title>Week 24 Bundesliga Predictions</title>
            ...
            <meta name="keywords" content="Week 24 Bundesliga Predictions, this week's Bundesliga Predictions predictions, football predictions, free betting prediction and insights, free football predictions, free football betting tips, free football betting predictions, football match analysis, sports betting insights, best football prediction site, accurate football betting tips, free football predictions, football betting form, football betting predictions today, basedonform.com" />
