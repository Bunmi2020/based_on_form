...
function SerieAPredictionsN() {
    ...
    ReactGA.send({
        hitType:"pageview",
        page:"/serie_a_predictions_week_27",
        title:"Week 27 Serie A Predictions",
    });
    ...
    const urls = ['https://bunmi2020.github.io/bnf_data/week_twenty/serie_a.json'];
    useEffect(() => {
    ...
    return (
        <div>
        <Helmet>
            <title>Week 27 Serie A Predictions</title>
            ...
            <meta name="keywords" content="Week 27 Serie A Predictions, this week's Serie A Predictions predictions, football predictions, free betting prediction and insights, free football predictions, free football betting tips, free football betting predictions, football match analysis, sports betting insights, best football prediction site, accurate football betting tips, free football predictions, football betting form, football betting predictions today, basedonform.com" />
